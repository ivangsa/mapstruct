...
@WithClasses({ SomeMapper.class, SourceWithOptional.class, TargetWithPlainValues.class })
@IssueKey("674")
...
public class OptionalConversionTest {
    ...
    public void shouldApplyOptionalConversions() {
        ...
        TargetWithPlainValues target = SomeMapper.INSTANCE.asPlain(source);
    ...
    public void shouldApplyReverseConversions() {
        ...
        SourceWithOptional source = SomeMapper.INSTANCE.asOptional(target);
